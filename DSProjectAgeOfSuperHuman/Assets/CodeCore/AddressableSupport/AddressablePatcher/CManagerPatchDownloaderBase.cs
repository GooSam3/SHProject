...
{
    public static string DownloadURL = "http://localhost/[BuildTarget]";
    ...
    protected void ProtPatchAddressableTotalDowloadSize(List<string> _listAssetBundleLable, UnityEngine.Events.UnityAction<long> _eventFinish)
	{
