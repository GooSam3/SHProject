...
public class ZeroConsoleGUI : MonoBehaviour
{
	[Serializable]
	...
	void Awake()
	{
		...
		UnityEngine.Application.logMessageReceived += OnCaptureLog;
	}
	...
	void OnCaptureLog(string log, string stacktrace, LogType type)
	{
