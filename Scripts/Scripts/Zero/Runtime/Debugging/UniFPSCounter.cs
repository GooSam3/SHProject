...
public class UniFPSCounter : MonoBehaviour
{
	...
	private void UpdateUISize()
	{
		...
		var rectLongSide = screenLongSide / 11;
		boxRect = new Rect(Screen.width - rectLongSide, 1, rectLongSide, rectLongSide / 3);
		//style.fontSize = (int)(screenLongSide / 36.8);
		style.fontSize = (int)(screenLongSide / 50f);
	...
	private void OnGUI()
	{
		...
		GUI.Label(boxRect, frameRate.ToString(), style);
	}
}