...
public class AddressableProviderScene : AddressableProviderBase<AddressableProviderScene>
{
    ...
    {
        mAsyncHandle = Addressables.LoadSceneAsync(mAddressableName, UnityEngine.SceneManagement.LoadSceneMode.Additive, true, pPriority);
