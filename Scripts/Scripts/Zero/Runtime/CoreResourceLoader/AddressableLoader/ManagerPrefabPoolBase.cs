...
public abstract class ManagerPrefabPoolBase : ManagerAddressableBase<ManagerPrefabPoolBase, AddressableProviderGameObject>
{   
	...
	/// </summary>
    protected void ReserveInstance(string _category, string _addressableName, int _priority, int _reserveCount, UnityAction<string, GameObject> _eventFinish, bool _autoRelease, bool _cloneInstance)
	{
		...
		{
			RequestLoad(_addressableName, _priority, (string _LoadedAddressableName, object _LoadedGameObject) =>
			{
