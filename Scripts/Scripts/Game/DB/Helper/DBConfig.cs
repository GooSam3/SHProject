...
public class DBConfig : IGameDBHelper
{
	...
	/// <summary> 시스템 알림 노출시간 </summary>
	public static float System_Notice_Show_Time { get; private set; }
	...
	/// <summary> 크라운 아이템 아이디 </summary>
	public static uint Crown_ID { get; private set; }
	...
	/// <summary>1차 무게 페널티 적용 직전 무게</summary>
	public static float Weight_Penalty_MidTerm { get; private set; }
	/// <summary>2차 무게 페널티 적용 직전 무게</summary>
	public static float Weight_Penalty_MaxTerm { get; private set; }
	...
	/// <summary> 길드 가입 최대 요청수 </summary>
	public static uint Guild_Request_Max { get; private set; }
	...
	/// <summary>마을 스테이지 아이디</summary>
	public static uint Town_Stage_ID { get; private set; }
	/// <summary>마을 포탈 아이디</summary>
	public static uint Town_Portal_ID { get; private set; }
	public static uint Start_Stage_ID { get; private set; }
	...
	/// <summary> 자동분해 펫 컬렉션 아이디  </summary>
	public static uint PetCollection_Auto_Break { get; private set; }
	...
	/// <summary> 이카루스의 빛 최대 중첩 개수 </summary>
	public static uint GodBuff_MaxCount { get; private set; }
	...
	/// <summary> - 채팅 매크로 쿨타임 </summary>
	public static float Chatting_Macro_Cooltime { get; private set; }

	/// <summary> - 채팅 최대 갯수 </summary>
	public static int Chatting_View_Max { get; private set; }

	/// <summary> - 채팅 최대 글자 수 </summary>
	public static int Chatting_Message_Char_Limit { get; private set; }

	/// <summary> - 채팅 길드인사 최대 글자 수 </summary>
	public static int Chatting_GuildGreeting_Char_Limit { get; private set; }

	/// <summary> - HUD상의 채팅이 사라질떄 까지 소요되는 시간(초) </summary>
	public static float HUD_Chatting_Fade_Interval { get; private set; }

	/// <summary> - 이전 채팅 로그 확인 중 자동 포커싱(신규 채팅 로그 발생 시 포커스) 재적용 대기 시간(초) </summary>
	public static float Chatting_Auto_SetEnd_Interval { get; private set; }
	...
	/// <summary> - 컬렉션 한페이지당 보여줄 슬롯의 갯수 </summary>
	public static uint PCR_Collection_Page_ViewCount { get; private set; }

	/// <summary> - 컬렉션 에서 보여줄 모델의 Y로테이션 </summary>
	public static float PCR_Collection_Rot_Y { get; private set; }
	...
	/// <summary> - 사망 경험치 패널티 일일 무료 복구 횟수 </summary>
	public static byte Death_ExpPenalty_RestoreFree { get; private set; }
	...
	/// <summary> 상점 및 창고 장바구니 갯수 </summary>
	public static uint Max_Trade_Queue_Count { get; private set; }
	...
	/// <summary> 펫, 강림, 탈것 합성시 최대 등록갯수 </summary>
	public static uint PCR_Combine_Max { get; private set; }
	...
	/// <summary> 1티어 아이템 색상 </summary>
	public static string Item_Grade01_Color { get; private set; }
	/// <summary> 2티어 아이템 색상 </summary>
	public static string Item_Grade02_Color { get; private set; }
	/// <summary> 3티어 아이템 색상 </summary>
	public static string Item_Grade03_Color { get; private set; }
	/// <summary> 4티어 아이템 색상 </summary>
	public static string Item_Grade04_Color { get; private set; }
	/// <summary> 5티어 아이템 색상 </summary>
	public static string Item_Grade05_Color { get; private set; }
	/// <summary> 6티어 아이템 색상 </summary>
	public static string Item_Grade06_Color { get; private set; }

	/// <summary> 타겟 스캔 거리 </summary>
	public static uint ScanDistance { get; private set; }
	/// <summary> 타겟 스캔 개수 </summary>
	public static uint SearchTargetCount { get; private set; }

	/// <summary>  몬스터 타격/피격 시 발생하는 경직 시간  1=1초 </summary>
	public static float Spasiticity_Time { get; private set; }
	/// <summary>  내캐릭터 경직 시간 </summary>
	public static float PC_Spasiticity_Time { get; private set; }
	/// <summary> 경직 발생 스피드 0=완전 멈춤,1=경직없음/0~1 사이값 사용 </summary>
	public static float Spasiticity_SwingTime { get; private set; }
	/// <summary>  1타 경직:0= 경직없음/1=경직 적용 </summary>
	public static byte Spasiticity_Actuation_Type1 { get; private set; }
	/// <summary>  2타 경직:0= 경직없음/1=경직 적용 </summary>
	public static byte Spasiticity_Actuation_Type2 { get; private set; }
	/// <summary>  3타 경직:0= 경직없음/1=경직 적용 </summary>
	public static byte Spasiticity_Actuation_Type3 { get; private set; }
	/// <summary>  1타 크리티컬 경직:0= 경직없음/1=경직 적용 </summary>
	public static byte Spasiticity_Actuation_Type4 { get; private set; }
	/// <summary>  2타 크리티컬 경직:0= 경직없음/1=경직 적용 </summary>
	public static byte Spasiticity_Actuation_Type5 { get; private set; }
	/// <summary>  3타 크리티컬 경직:0= 경직없음/1=경직 적용 </summary>
	public static byte Spasiticity_Actuation_Type6 { get; private set; }

	/// <summary> 1타의 카메라 쉐이크 강도 1=기본 강도/0=쉐이킹 없음 </summary>
	public static float Camshake_Strength1 { get; private set; }
	/// <summary> 2타의 카메라 쉐이크 강도 1=기본 강도/0=쉐이킹 없음 </summary>
	public static float Camshake_Strength2 { get; private set; }
	/// <summary> 3타의 카메라 쉐이크 강도 1=기본 강도/0=쉐이킹 없음 </summary>
	public static float Camshake_Strength3 { get; private set; }
	/// <summary> 크리티컬의 카메라 쉐이크 강도 1=기본 강도/0=쉐이킹 없음 </summary>
	public static float Camshake_Strength4 { get; private set; }
	/// <summary> 스킬의 카메라 쉐이크 강도  1=기본 강도/0=쉐이킹 없음 </summary>
	public static float Camshake_Strength5 { get; private set; }
	/// <summary> 카메라 쉐이크 지속 시간 </summary>
	public static float Camshake_Time { get; private set; }
	/// <summary> 카메라 상하 회전값 </summary>
	public static float CameraSpeedRotateX { get; private set; }
	/// <summary> 카메라 좌우 회전값 </summary>
	public static float CameraSpeedRotateY { get; private set; }

	////// <summary> 아티팩트 사용 가능 레벨 </summary>
	public static int Artifact_Use_Level { get; private set; }

	////// <summary> 속성 강화 사용 가능 레벨 </summary>
	public static byte Attribute_Require_Level { get; private set; }

	////// <summary> 펫 탐험용 힛 이펙트1(1~3 랜덤하게 플레이) 파일명 </summary>
	public static uint Pet_Expedition_Hit01 { get; private set; }
	////// <summary> 펫 탐험용 힛 이펙트1(1~3 랜덤하게 플레이) 파일명 </summary>
	public static uint Pet_Expedition_Hit02 { get; private set; }
	////// <summary> 펫 탐험용 힛 이펙트1(1~3 랜덤하게 플레이) 파일명 </summary>
	public static uint Pet_Expedition_Hit03 { get; private set; }


	/// <summary>불속성 헥스코드 컬러값</summary>
	public static string Color_Conversion_Fire { get; private set; }
	/// <summary>물속성 헥스코드 컬러값</summary>
	public static string Color_Conversion_Water { get; private set; }
	/// <summary>전기속성 헥스코드 컬러값</summary>
	public static string Color_Conversion_Eletricity { get; private set; }
	/// <summary>빛속성 헥스코드 컬러값</summary>
	public static string Color_Conversion_Light { get; private set; }
	/// <summary>어둠속성 헥스코드 컬러값</summary>
	public static string Color_Conversion_Dark { get; private set; }
	/// <summary>색상 변환 사용 여부 0=사용안함,1=사용함</summary>
	public static float Color_Conversion_State { get; private set; }
	/// <summary>속성따라 색변환을 일으키지 않을 때 사용하는 디폴트 컬러</summary>
	public static string Color_Conversion_DefaultColor { get; private set; }
	/// <summary>색상 변환 약함(1~2사이값 적용, 숫자가 클수록 강함)</summary>
	public static float Color_Conversion_Strength1 { get; private set; }
	/// <summary색상 변환 강함(1~2사이값 적용, 숫자가 클수록 강함)></summary>
	public static float Color_Conversion_Strength2 { get; private set; }
	/// <summary>색상 변환이 적용되는 시간( 생성~사망)</summary>
	public static float Color_Conversion_Time { get; private set; }
	/// <summary>카메라 줌 값</summary>
	public static float Zoom_Speed { get; private set; }
	/// <summary>요리 오픈 레벨</summary>
	public static uint Cooking_Require_Level { get; private set; }

	/// <summary> 채집 타겟 찾기 거리 </summary>
	public static float Gather_Interaction_Distance = 2f;

	/// <summary> 콜로세움 라운드 별 진행 시간  </summary>
	public static byte WPvP_Round_Time { get; private set; }

	/// <summary> 성지 컨텐츠 이용 시 사용하는 스태미나(크라운) </summary>
	public static uint GodLand_Require_Stamina { get; private set; }

	/// <summary> 성지 컨텐츠 이용 시 사용하는 스태미나(크라운) 최대값  </summary>
	public static uint GodLand_Require_Stamina_Max { get; private set; }

	/// <summary> 성지 생산재화  </summary>
	public static uint Godland_Production_ID { get; private set; }

	/// <summary> 아이템 버프, 변신, 펫소환 미리 사용하는 시간(초) </summary>
	public static uint Buff_Pre_Start_Time { get; private set; }

	/// <summary> 채널이동 쿨타임 </summary>
	public static uint Portal_Delay_Time { get; private set; }

	/// <summary> 길드 던전이 종료(보스 처치 혹은 시간 종료) 된 후 스테이지내의 모든 유저가 퇴장될때까지 유예시간 </summary>
	public static byte GuildDungeon_Close_Exit_Time { get; private set; }

	/// <summary> 길드 던전이 종료(보스 처치 혹은 시간 종료) 된 후 새로운 길드 던전을 오픈할 때 까지 대기시간 </summary>
	public static byte GuildDungeon_ReOpen_CoolTime { get; private set; }

	#region ===== :: 선 악 최대 수치 (DBPKBuff 에서 셋팅됨):: =====
	/// <summary> 선함 최대 수치 </summary>
	public static int MaxGoodTendency = 0;
	/// <summary> 악함 최대 수치 (마이너스 값)</summary>
	public static int MaxEvilTendency = 0;
	#endregion

	#region ===== :: 유적 관련 :: =====
	/// <summary> 캐릭터의 무게 </summary>
	public static float Temple_PCWeight { get; private set; }

	/// <summary> 속성 레벨 </summary>
	private static Dictionary<uint, E_AttributeLevel> m_dicAttributeLevel = new Dictionary<uint, E_AttributeLevel>();

	/// <summary> 등급에 따라 속성레벨 얻어온다. </summary>
	public static E_AttributeLevel GetAttributeLevel(byte grade)
	{
		if (false == m_dicAttributeLevel.TryGetValue(grade, out var level))
			return E_AttributeLevel.Level_1;
	...
	public void OnReadyData()
	{
		...
		Town_Stage_ID = GetUInt32("Town_Stage_ID");
		Town_Portal_ID = GetUInt32("Town_Portal_ID");
		Start_Stage_ID = GetUInt32("Start_Stage_ID");
		...
		Guild_Request_Max = GetUInt32("Guild_Request_Max");
		...
		PetCollection_Auto_Break = GetUInt32("PetCollection_Auto_Break");
		...
		GodBuff_MaxCount = GetUInt32("GodBuff_MaxCount");
		...
		Death_ExpPenalty_RestoreFree = (byte)GetUInt32("Death_ExpPenalty_RestoreFree");
		...
		Chatting_Macro_Cooltime = GetFloat(nameof(Chatting_Macro_Cooltime), 3f);
		Chatting_View_Max = GetInt32(nameof(Chatting_View_Max), 100);
		Chatting_Message_Char_Limit = GetInt32(nameof(Chatting_Message_Char_Limit), 50);
		Chatting_GuildGreeting_Char_Limit = GetInt32(nameof(Chatting_GuildGreeting_Char_Limit), 20);

		HUD_Chatting_Fade_Interval = GetFloat(nameof(HUD_Chatting_Fade_Interval));
		Chatting_Auto_SetEnd_Interval = GetFloat(nameof(Chatting_Auto_SetEnd_Interval));
		...
		MagicAttackViewValue = GetFloat("MagicAttackViewValue", 1.2f);
		...
		System_Notice_Show_Time = GetFloat(nameof(System_Notice_Show_Time), 2f);
		...
		Max_Trade_Queue_Count = GetUInt32(nameof(Max_Trade_Queue_Count), 20);
		...
		Item_Grade01_Color = Get(nameof(Item_Grade01_Color));
		Item_Grade02_Color = Get(nameof(Item_Grade02_Color));
		Item_Grade03_Color = Get(nameof(Item_Grade03_Color));
		Item_Grade04_Color = Get(nameof(Item_Grade04_Color));
		Item_Grade05_Color = Get(nameof(Item_Grade05_Color));
		Item_Grade06_Color = Get(nameof(Item_Grade06_Color));

		PCR_Combine_Max = GetUInt32(nameof(PCR_Combine_Max), 400);

		PCR_Collection_Page_ViewCount = GetUInt32(nameof(PCR_Collection_Page_ViewCount), 5);
		PCR_Collection_Rot_Y = GetFloat(nameof(PCR_Collection_Rot_Y), 30f);

		ScanDistance = GetUInt32("ScanDistance");
		SearchTargetCount = GetUInt32("SearchTargetCount");

		Weight_Penalty_MidTerm = GetFloat(nameof(Weight_Penalty_MidTerm), 0f);
		Weight_Penalty_MaxTerm = GetFloat(nameof(Weight_Penalty_MaxTerm), 0f);

		Temple_PCWeight = GetFloat(nameof(Temple_PCWeight), 0f);

		Spasiticity_Time = GetFloat("Spasiticity_Time");
		PC_Spasiticity_Time = GetFloat("PC_Spasiticity_Time");
		Spasiticity_SwingTime = GetFloat("Spasiticity_SwingTime");
		Spasiticity_Actuation_Type1 = (byte)GetUInt32("Spasiticity_Actuation_Type1");
		Spasiticity_Actuation_Type2 = (byte)GetUInt32("Spasiticity_Actuation_Type2");
		Spasiticity_Actuation_Type3 = (byte)GetUInt32("Spasiticity_Actuation_Type3");
		Spasiticity_Actuation_Type4 = (byte)GetUInt32("Spasiticity_Actuation_Type4");
		Spasiticity_Actuation_Type5 = (byte)GetUInt32("Spasiticity_Actuation_Type5");
		Spasiticity_Actuation_Type6 = (byte)GetUInt32("Spasiticity_Actuation_Type6");
		Camshake_Strength1 = GetFloat("Camshake_Strength1");
		Camshake_Strength2 = GetFloat("Camshake_Strength2");
		Camshake_Strength3 = GetFloat("Camshake_Strength3");
		Camshake_Strength4 = GetFloat("Camshake_Strength4");
		Camshake_Strength5 = GetFloat("Camshake_Strength5");
		Camshake_Time = GetFloat("Camshake_Time");

		CameraSpeedRotateX = GetFloat("CameraSpeedRotateX");
		CameraSpeedRotateY = GetFloat("CameraSpeedRotateY");

		Artifact_Use_Level = (byte)GetUInt32("Artifact_Use_Level");

		Attribute_Require_Level = (byte)GetUInt32("Attribute_Require_Level");

		Color_Conversion_Fire = Get("Color_Conversion_Fire");
		Color_Conversion_Water = Get("Color_Conversion_Water");
		Color_Conversion_Eletricity = Get("Color_Conversion_Eletricity");
		Color_Conversion_Light = Get("Color_Conversion_Light");
		Color_Conversion_Dark = Get("Color_Conversion_Dark");
		Color_Conversion_State = GetFloat("Color_Conversion_State");
		Color_Conversion_DefaultColor = Get("Color_Conversion_DefaultColor");
		Color_Conversion_Strength1 = GetFloat("Color_Conversion_Strength1");
		Color_Conversion_Strength2 = GetFloat("Color_Conversion_Strength2");
		Color_Conversion_Time = GetFloat("Color_Conversion_Time");
		Zoom_Speed = GetFloat("Zoom_Speed", 0.5f);

		Pet_Expedition_Hit01 = GetUInt32(nameof(Pet_Expedition_Hit01));
		Pet_Expedition_Hit02 = GetUInt32(nameof(Pet_Expedition_Hit02));
		Pet_Expedition_Hit03 = GetUInt32(nameof(Pet_Expedition_Hit03));

		Gather_Interaction_Distance = GetFloat("Gather_Interaction_Distance", 2f);

		WPvP_Round_Time = (byte)GetUInt32("WPvP_Round_Time");

		Cooking_Require_Level = GetUInt32("Cooking_Require_Level");

		GodLand_Require_Stamina = GetUInt32("GodLand_Require_Stamina");
		GodLand_Require_Stamina_Max = GetUInt32("GodLand_Require_Stamina_Max");
		Godland_Production_ID = GetUInt32("Godland_Production_ID");

		Buff_Pre_Start_Time = GetUInt32("Buff_Pre_Start_Time");

		Portal_Delay_Time = GetUInt32("Portal_Delay_Time");
		Death_ExpPenalty_RestoreFree = (byte)GetUInt32("Death_ExpPenalty_RestoreFree");
		GuildDungeon_Close_Exit_Time = (byte)GetUInt32("GuildDungeon_Close_Exit_Time");
		GuildDungeon_ReOpen_CoolTime = (byte)GetUInt32("GuildDungeon_ReOpen_CoolTime");

		//등급에 따른 속성 셋팅
		m_dicAttributeLevel.Clear();
		uint grade = 1;
		while (true)
		{
			string key = $"Change{grade}_AttributeGrade";
			if (false == GameDBManager.Container.Config_Table_data.TryGetValue(key, out var table))
				break;

			m_dicAttributeLevel.Add(grade, (E_AttributeLevel)GetUInt32(key, 1));
			++grade;
		}
	}
