...
[AddComponentMenu("ZUI/ZImageClickable", 12)]
public class ZImageClickable : UnityEngine.UI.Image, IPointerDownHandler, IPointerClickHandler,  IPointerUpHandler, IInitializePotentialDragHandler, IDragHandler, IDropHandler, IEndDragHandler, IBeginDragHandler
{
    ...
    private UnityAction<Vector2> mPointerDown;
    private UnityAction<Vector2> mPointerUp;
    private UnityAction<Vector2> mPointerDrag;
    private UnityAction<Vector2> mPointerDrop;
    private UnityAction<Vector2> mPointerDragBegin;
    private UnityAction<Vector2> mPointerDragEnd;
    private UnityAction<Vector2> mPointerPotentialDrag;
    private UnityAction<Vector2> mPointerLongPress;
