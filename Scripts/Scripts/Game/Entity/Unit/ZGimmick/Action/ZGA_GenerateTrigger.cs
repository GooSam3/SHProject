...
public class ZGA_GenerateTrigger : ZGimmickActionDetectEventBase
{
    [Header("체크할 기믹 ID")]
    [SerializeField]
    ...
    {
        Gimmick.InvokeActions(E_GimmickActionInvokeType.Enable, E_AttributeLevel.Level_1);

        //foreach (var id in m_listEnableGimmickId)
        //{
        //    Gimmick.InvokeActions(E_GimmickActionInvokeType.Enable);
        //}
    }
}